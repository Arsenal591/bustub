 ...
 */
bool BPlusTreePage::IsLeafPage() const { page_type_ == IndexPageType::LEAF_PAGE; }
...
bool BPlusTreePage::CanInsert(int num) { return size_ + num <= max_size_ + 1; }

bool BPlusTreePage::CanInsertWithoutSplit(int num) { return size_ + num <= max_size_; }

bool BPlusTreePage::NeedToSplit() { return size_ == max_size_ + 1; }

bool BPlusTreePage::NeedToShrink() { return size_ < GetMinSize(); }

bool BPlusTreePage::IsEmpty() { return size_ == 0; }
